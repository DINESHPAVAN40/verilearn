    ...
    <nav className="bg-white dark:bg-gray-800 shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/simulator" className="hover:text-primary transition">
            Simulator
          </Link>
      ...
      {menuOpen && (
        <div className="md:hidden bg-gray-50 dark:bg-gray-700 px-4 py-4 space-y-3">
          ...
          <Link href="/simulator" className="block hover:text-primary transition">
            Simulator
          </Link>
          <Link href="/quizzes" className="block hover:text-primary transition">
            Quizzes
          </Link>
          {user ? (
            <>
