...
import { FiCode, FiBook, FiZap, FiAward } from 'react-icons/fi';
...
const features = [
  ...
  },
  {
    icon: FiZap,
    title: 'Simulator',
    description: 'Simulate your Verilog code with waveform visualization and timing analysis',
  },
  {
    icon: FiAward,
    title: 'Quizzes',
    description: 'Test your knowledge with interactive quizzes and get detailed explanations',
  },
];
      ...
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-secondary to-accent">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-100 mb-8">
            Learn digital design with interactive workspace, simulator, quizzes, and comprehensive guides
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-white text-primary font-bold rounded-lg hover:bg-gray-100 transition w-full sm:w-auto"
              >
                Get Started Free
              </motion.button>
            </Link>
            <Link href="/guides">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-white text-white font-bold rounded-lg hover:bg-white/10 transition w-full sm:w-auto"
              >
                Explore Guides
              </motion.button>
            </Link>
